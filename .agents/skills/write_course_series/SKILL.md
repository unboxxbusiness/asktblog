...
description: Generate and publish a 5-part interconnected micro-course series based on daily trending topics using YouTube API & Google Search grounding.
---

# Instructions for Drafting & Publishing 5-Part Interconnected Course Series
...
1. Use **Google Grounded Search** to find today's #1 breaking viral trend.
2. Query **YouTube Data API v3** (using `YOUTUBE_API_KEY` from `.env.local`) to pull video IDs, channel benchmarks, and key timestamps.
...
* **Part 3: Hands-On Tutorial & Video Walkthrough** (`<p>1. Step 1 (Action): ...</p>` checklist, code setup, embedded YouTube video reference)
* **Part 4: Real-World Case Study & Metrics** (Before/After comparison table, ROI metrics, real stories)
* **Part 5: Advanced Masterclass & Future Roadmap** (Decision matrix, comprehensive `<div class="geo-faq">`, resources, CTA)
