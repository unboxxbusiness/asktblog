...
Choose the single most viral and developer-relevant theme from the topics above.
...
### Output JSON Format:
{
  "title": "[Engaging, keyword-rich headline. Keep under 60 characters]",
  "excerpt": "[Detailed, compelling summary. Keep under 150 characters]",
  "category": "[Must match exactly one of these: AI News, AI Tools, Automation, CRM, Business Growth, Career, Industry Insights, Productivity]",
  ...
  "viral_score": 90,
  "source_name": "[The primary source channel/name, e.g. IBM Technology, Google AI Blog]",
  "source_url": "[URL of the primary source reference]",
  "research_ref": "[Citation reference name, e.g. IBM Technology AI Guide 2026]",
