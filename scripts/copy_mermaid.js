 ...
 * as a local static asset (/mermaid.min.js).
 * Loading from same-origin bypasses all Content-Security-Policy restrictions
 * and avoids Webpack dynamic import / code-splitting issues entirely.
 */
const fs   = require("fs");
