...
export default function PrivacyPolicyPage() {
  return (
    <PolicyLayout title="Privacy Policy" lastUpdated="July 9, 2026">
      <p>
        This Privacy Policy explains how TheAskt (&ldquo;TheAskt,&rdquo; &ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) collects, uses, stores, and protects information when you visit our website or use our services (collectively, the &ldquo;Platform&rdquo;). We designed this Platform to require as little personal information as possible. There are no user accounts, no login, and no user dashboard — meaning the vast majority of your interaction with TheAskt involves no personal data collection at all.
      </p>
      <p className="mt-4">
        This policy applies to all visitors, readers, and subscribers of TheAskt.
      </p>
      ...
      <p>
        We may collect information about the website or source that referred you to TheAskt (e.g., a search engine, social media platform, or another website), primarily for analytics purposes.
      </p>
      ...
      <p>
        Push notifications require your explicit browser-level permission. You will be prompted by your browser to allow or deny notifications from TheAskt; we cannot send notifications unless you grant this permission.
      </p>
      <p className="mt-2">
      ...
      <p>
        Depending on your jurisdiction (such as DPDP in India, GDPR in the EU, or CCPA in California), you may have some or all of the following rights regarding your personal data:
      </p>
      <ul className="list-disc pl-5 space-y-1 text-xs text-muted-foreground my-2">
