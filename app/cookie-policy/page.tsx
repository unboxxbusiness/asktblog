...
export default function CookiePolicyPage() {
  return (
    <PolicyLayout title="Cookie Policy" lastUpdated="July 9, 2026">
      <p>
        Cookies are small text files stored on your device when you visit a website. TheAskt uses cookies and similar technologies for the following purposes:
      </p>
