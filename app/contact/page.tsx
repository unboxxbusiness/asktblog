    ...
    <div className="max-w-5xl mx-auto space-y-12 py-6">
      <header className="text-center space-y-3 max-w-xl mx-auto">
        ...
        <h1 className="font-heading text-3xl sm:text-4xl font-extrabold tracking-tight text-foreground">
          Contact TheAskt Support
        </h1>
        <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
          Have questions about AI integrations, CRM architectures, or automation templates? Drop us a message and our team will get back to you.
        </p>
      </header>
        ...
        <div className="md:col-span-4 bg-card border border-border p-6 rounded-2xl space-y-6">
          ...
          <div className="space-y-4 pt-2">
            <div className="flex gap-3 items-start">
              ...
              <div>
                <h4 className="text-xs font-bold text-foreground">General & Technical Support</h4>
                <a href="mailto:support@theaskt.org" className="text-xs text-muted-foreground hover:text-primary transition-colors">
                  support@theaskt.org
                </a>
              </div>
            </div>
            ...
            <div className="flex gap-3 items-start">
              ...
              <div>
                ...
                <a href="mailto:editorial@theaskt.org" className="text-xs text-muted-foreground hover:text-primary transition-colors">
                  editorial@theaskt.org
                </a>
              </div>
            </div>
            ...
            <div className="flex gap-3 items-start">
              ...
              <div>
                ...
                <a href="mailto:privacy@theaskt.org" className="text-xs text-muted-foreground hover:text-primary transition-colors">
                  privacy@theaskt.org
                </a>
              </div>
            </div>
            ...
            <div className="flex gap-3 items-start">
              ...
              <div>
                ...
                <a href="mailto:partners@theaskt.org" className="text-xs text-muted-foreground hover:text-primary transition-colors">
                  partners@theaskt.org
                </a>
              </div>
            </div>
          </div>
          ...
          {status === "success" ? (
            <div className="text-center py-10 flex flex-col items-center justify-center">
              ...
              <p className="text-xs text-muted-foreground max-w-sm leading-relaxed mb-6">
                Thank you for contacting us, {name || "there"}. We have registered your lead details and our business specialists will email you shortly.
              </p>
              <button
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  placeholder="Tell us about your project requirements or what you are looking to learn..."
                  rows={5}
