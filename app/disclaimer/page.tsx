...
export default function DisclaimerPage() {
  return (
    <PolicyLayout title="Disclaimer" lastUpdated="July 9, 2026">
      ...
      <p className="mt-2">
        TheAskt does not provide investment advice, and nothing on the Platform should be interpreted as a recommendation to buy, sell, or hold any security, cryptocurrency, or investment product. Consult a qualified financial professional before making financial decisions.
      </p>

      <h2 className="font-heading text-lg font-bold text-foreground mt-6 mb-2">6. External Links & Sourcing Disclaimer</h2>
      <p>
        TheAskt may link to third-party tools, articles, and resources for reference. We do not control, endorse, or take responsibility for the accuracy, legality, or content of external websites.
      </p>
      ...
      <p>
        TheAskt is committed to ensuring digital accessibility for all users, including people with disabilities. We continually apply improvements to enhance the user experience and conform to relevant accessibility guidelines.
      </p>
    </PolicyLayout>
  );
}
