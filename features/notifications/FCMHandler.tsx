...
export default function FCMHandler() {
  ...
  const handleSubscribe = async () => {
    ...
    try {
      ...
      // 3. Register the Firebase Messaging SW explicitly
  ...
  let modalDesc =
    "Be the first to learn new AI automation recipes, trending tech updates, and CRM hacks. No spam, just pure skills.";
  let modalFooter = (
  ...
  if (status === "unsupported") {
    ...
    modalDesc =
      "You are successfully subscribed! You will receive real-time notifications for breaking AI developments, workflow templates, and career roadmaps.";
    modalFooter = (
      <div className="flex w-full gap-3">
        <button
          onClick={handleDismiss}
