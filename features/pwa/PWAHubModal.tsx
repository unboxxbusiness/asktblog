  ...
  const handleInstallApp = async () => {
    if (deferredPrompt) {
      ...
      if (isIOS) {
        ...
        alert("TheAskt is already installed on your device! You can open it from your applications menu or search shortcuts.");
      }
    }
  };
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="bg-secondary/25 border border-border rounded-xl p-5 flex flex-col items-center text-center justify-between min-h-[240px]">
              ...
              <p className="text-[10px] text-muted-foreground leading-relaxed mt-1 flex-grow">
                Install **TheAskt** directly to your home screen for quick, offline-capable access and zero loading lag.
              </p>
