    ...
    <div className="fixed bottom-4 left-4 right-4 md:left-auto md:right-4 z-50 max-w-sm glass border border-border p-4 rounded-xl shadow-2xl flex flex-col gap-3 animate-fade-in-up">
      <div className="flex items-start justify-between">
        <div className="flex gap-3">
          ...
          <div>
            <h4 className="font-heading font-bold text-sm text-foreground">Install TheAskt</h4>
            <p className="text-xs text-muted-foreground mt-0.5 leading-snug">
              Access previously read articles offline and get push alerts directly on your device.
            </p>
          </div>
        </div>
        <button
