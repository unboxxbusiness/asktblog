...
import { Twitter, Linkedin, Facebook, Rss, Map, Send, Loader2, TrendingUp } from "lucide-react";
    ...
    <footer className="bg-secondary/40 border-t border-border mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="flex flex-col gap-4">
            <Link href="/" className="flex items-center gap-2.5 group">
              ...
              <div className="relative h-8 w-8 rounded-lg bg-gradient-to-tr from-[#14213d] to-[#1d325c] dark:from-[#fca311] dark:to-[#ffbd44] flex items-center justify-center shadow-sm group-hover:scale-105 transition-transform duration-300">
                <TrendingUp className="w-4.5 h-4.5 text-white dark:text-[#14213d]" />
              </div>
              {/* Elegant Hybrid Logo Typography */}
              <span className="flex items-baseline font-heading tracking-tight select-none">
                <span className="font-serif italic font-normal text-foreground/90 text-lg lowercase mr-0.5">the</span>
                <span className="font-black text-lg text-primary uppercase tracking-tighter">askt</span>
              </span>
            </Link>
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="text-xs text-muted-foreground">
              Subscribe to get the latest AI workflows, automation hacks, and CRM strategies.
            </p>
        ...
        <div className="border-t border-border mt-12 pt-6 flex flex-col sm:flex-row items-center justify-between text-xs text-muted-foreground gap-4">
          <div>
            © {new Date().getFullYear()} {siteConfig.name}. Learn AI. Build Skills. Create Opportunities.
          </div>
        </div>
      </div>
    </footer>
